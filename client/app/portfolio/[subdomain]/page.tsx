      ...
      <section className="py-20 px-6 max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 border-b border-gray-50">
        <div className="flex-1 space-y-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            {personalInfo.github && (
              <a href={formatUrl(personalInfo.github)} target="_blank" rel="noopener noreferrer" className="p-2 border rounded-full hover:border-gray-900 text-gray-500 hover:text-gray-900 transition flex items-center justify-center">
            ...
            {personalInfo.linkedin && (
              <a href={formatUrl(personalInfo.linkedin)} target="_blank" rel="noopener noreferrer" className="p-2 border rounded-full hover:border-blue-600 text-gray-500 hover:text-blue-600 transition flex items-center justify-center">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
            ...
            {projects.map((proj: any, index: number) => (
              <div key={index} className="border border-gray-100 rounded-2xl p-6 hover:shadow-lg transition flex flex-col justify-between space-y-4">
                ...
                <div className="flex gap-4 text-xs font-bold">
                  {proj.github && (
                    <a href={formatUrl(proj.github)} target="_blank" rel="noopener noreferrer" className={`${colors.text} hover:underline`}>
                      Source Code
                    </a>
                  )}
                  {proj.liveDemo && (
                    <a href={formatUrl(proj.liveDemo)} target="_blank" rel="noopener noreferrer" className={`${colors.text} hover:underline`}>
                      Live Project
                    </a>
                  )}
                </div>
